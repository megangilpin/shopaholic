...
})(["margin:0 1rem;text-align:center;a{display:inline;padding:2rem;border:0;border-radius:10px;text-transform:uppercase;&:hover{color:", ";text-shadow:", ";outline:none;box-shadow:none;font-weight:300;font-size:1.8em;}}"], function (props) {
  return props.theme.lightgrey;
}, function (props) {
