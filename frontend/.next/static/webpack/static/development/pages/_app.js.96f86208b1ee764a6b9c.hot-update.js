...
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;a{padding:2rem;background:", ";color:", ";font-size:5rem;font-weight:200;letter-spacing:0.1em;text-shadow:", ";border:0;border-radius:10px;text-transform:uppercase;text-decoration:none;}a:hover{color:", ";box-shadow:-6px -6px 10px white,1px 1px 5px rgba(0,0,0,0.1);}@media (max-width:1300px){margin:0;text-align:center;a{padding:0.5rem 1rem;}}"], function (props) {
...
//# sourceMappingURL=_app.js.96f86208b1ee764a6b9c.hot-update.js.map