...
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;a{padding:2rem;background:", ";color:", ";text-shadow:", ";font-size:7rem;font-weight:400;letter-spacing:0.1em;border:0;border-radius:10px;text-transform:uppercase;text-decoration:none;transition:all .3s;@media (max-width:700px){font-size:5rem;a{font-size:6rem;padding:0.5rem 1rem;}}}a:hover{color:", ";box-shadow:-6px -6px 10px white,1px 1px 5px rgba(0,0,0,0.1);-webkit-transform:scale(1.1);-ms-transform:scale(1.1);transform:scale(1.1);}@media (max-width:1300px){margin:0;text-align:center;a{font-size:8rem;padding:0.5rem 1rem;}}"], function (props) {
...
//# sourceMappingURL=_app.js.204aee4cd1d2c2623b51.hot-update.js.map