...
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;a{padding:2rem;background:", ";color:", ";font-size:6rem;font-weight:500;letter-spacing:0.1em;text-shadow:", ";border:0;border-radius:10px;text-transform:uppercase;text-decoration:none;}a:hover{color:", ";box-shadow:-6px -6px 10px white,1px 1px 5px rgba(0,0,0,0.1);}@media (max-width:1300px){margin:0;text-align:center;a{padding:0.5rem 1rem;}}"], function (props) {
...
//# sourceMappingURL=_app.js.0eb5157492c53b4006b9.hot-update.js.map